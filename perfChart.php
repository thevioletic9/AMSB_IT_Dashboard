      ...
      <div class="container-fluid" >
        <div class="row d-flex justify-content-center ">
          <div class="col-lg-15 ">
            <div class="card">
              <div class="card-body">
              <h4>Received Record for IT Feedback </h4>
...
?>                        <option value="All Data" >ALL</option>
                    ...
                    <div class="col-sm">
                       ...
                       <!-- BUTTONS -->
                        ...
                        <a href="perfChart.php" class="btn btn-dark" >Reset</a></br>
            ...
            <script>
                ...
                <div class="col-sm">
                  ...
                  <?php if ( ($from_date || $end_date  ||  $year   || $dept  ||  $status) <> "") { ?>
                      ...
                      <!--<span class="btn btn-secondary btn-m float-right mr-2" role="button">Print </span> -->
                      <a href="perfChartPrint.php?from_date=<?php echo $from_date ?>&end_date=<?php echo $end_date ?>&year=<?php echo $year ?>&DIC=<?php echo $dept ?>&Status=<?php echo $status ?>" name="print" target="_blank" class="btn btn-secondary noprint float-right mr-2">Print</a>
