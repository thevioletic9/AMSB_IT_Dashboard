            ...
            <div class="card">
              ...
              <div class="row">
                    <div class="col-md">
                        ...
                        <canvas id="outlabeledChart" style="min-height:500px; height: 250px;  max-width: 100%;"></canvas>
                   ...
                   <div class="col-md">
                        ...
                        <canvas id="outlabeledChart2" style="min-height: 500px; height: 250px; max-width: 100%;"></canvas>
                    ...
                    <div class="col-md">
                        ...
                        <canvas id="bar-chart" style="min-height: 500px; height: 250px;  max-width: 100%;"></canvas>
                    </div> 
                </div>
	...
	var myData = {
	   ...
	   duration: 1,
        //count function to display on the bar
            ...
            document.title = 'IT Feedback Record' + <?php echo json_encode($titleChart); ?> + '.pdf';
            window.print();
